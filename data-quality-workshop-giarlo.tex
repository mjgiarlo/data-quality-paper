...
\usepackage{hyperref}
% For formatting certain characters that you might expect to format normally
\usepackage[T1]{fontenc}

\begin{document}

\title{Academic Libraries as Data Quality Hubs\titlenote{Prepared for
    the NSF III \#1247471 \textbf{Curating for Quality: Ensuring
      Data Quality to Enable New Science} workshop in Arlington, VA, USA \\
    \\
    \copyright \ 2012 by Michael J. Giarlo. This work is licensed
    under a Creative Commons Attribution-ShareAlike 3.0 (CC BY-SA 3.0)
    License. You are free to share (to copy, distribute and transmit
    the work), to remix (to adapt the work), and to make commercial
    use of the work, under the following conditions: 1) you must
    ...
    or your use of the work); 2) if you alter, transform, or build
    upon this work, you may distribute the resulting work only under
    the same or similar license to this one; 3) any of the above
    conditions can be waived if you get permission from the copyright
    holder. Read more about this Creative Commons license here:
...
\category{H.3.7}{Digital Libraries}{General}
...
or the expertise to curate their own data \footnote{Hereafter referred
  ...
  \cite{curry:community}.}, and so its curation falls to other parties
...
\cite{arl:stewardship,heidorn:libraries,curry:community,jisc:deluge}. The
...
understand the data'' \cite{heidorn:libraries}. Whether researchers
...
\item[Trust] \hfill \\
  ...
  authentic, the uses to which the data is put, the subject
  discipline, the reputation of the party/ies responsible for the
  data, and the biases of the person who is evaluating the data
  \footnote{Trust is a complex issue that though relevant is too
    far-reaching to be within the the scope of this position paper. It
    is nonetheless listed in the framework at the very top to
...
\item[Understandability] \hfill \\
  ...
  sufficient context (documentation, metadata, or provenance)
...
\item[Usability] \hfill \\
  ...
  access the data; and that the data is of sufficient integrity to be
  rendered.
...
% blah...  \cite{heidorn:libraries} argue that the library is the
...
% application will likely need enhancement'' \cite{ogburn:imperative}
% (archival principles!)
