...
% TODO: restore this: \author{Michael J. Giarlo}
\author{Author}
% TODO: restore this: \leftheader{Giarlo}
\leftheader{Author}
% TODO: restore this: \affiliation{Penn State University}
...
% TODO: \authornote{michael@psu.edu}
\authornote{Email Address}
...
and data banks that are funded by the U.S. government. The government,
...
\footnote{Ogburn
  \textcite{ogburn:imperative} cites Stephen Jay Gould's The
  Mismeasure of Man: ``analysis and critique
  of cranial measurements in the 1800s, twin studies in the 1950s, and
  the rise of IQ testing were possible because the data were still
  available for scrutiny and replication''}; how do we as a society,
and particularly we within academia, not only preserve this wealth of
data for future science but ensure it is of high quality?
...
research'' \textcite{knight:quality}. Common features are identified for
...
Curry's chapter on community data curation \textcite{curry:community}.
...
Curry \textcite{curry:community} has identified a number of social and
